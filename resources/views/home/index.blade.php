            ...
            <div class="box">
                <article class="media">
                    ...
                    <div class="media-content">
                        <div class="content">
                            <p>
                                <strong><a href="{{ url('/movie/') }}/{{$movie->getId()}}" style="text-decoration:none;color: black;"><?= $movie->getoriginalTitle(); ?></a></strong> <small><i></i></small> <small class="is-pulled-right"></small><br>
                                <br>
